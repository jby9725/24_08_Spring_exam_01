...
<!-- <style> -->
<!-- /* .styled-table { */ /* width: 100%; */ /* border-collapse: collapse; */ /* border: 2px solid blue; */ /* } */ /* -->
<!-- .styled-table th, .styled-table td { */ /* text-align: center; */ /* padding: 5px; */ /* border: 1px solid blue; */ /* -->
<!-- color: black; */ /* } */ /* .styled-table th { */ /* font-weight: bold; */ /* } */ /* .styled-table a { */ /* -->
